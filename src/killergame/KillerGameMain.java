 ...
 *
 * A simple room-based killer game where: - Player is a blue triangle controlled
 * with WASD - Enemies are red circles that spawn from the edges - Goal: Survive
 * as long as possible
 */
